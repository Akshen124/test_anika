            ...
            <div className="brand-header-mobile">
              ...
              <div className="socials-section">
                <div className="social-box-links">
                  <a href="https://www.instagram.com/anikafashionstore.jewellery/?hl=en" className="social-box-icon" aria-label="Instagram">
                    <img src={InstagramIcon} alt="Instagram" />
                  </a>
                  <a href="https://www.facebook.com/people/anikafashionstore/100090910872220/?mibextid=ZbWKwL" className="social-box-icon" aria-label="Facebook">
